...
public class Principal_JPanel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Principal_JPanel frame = new Principal_JPanel();
	...
	public Principal_JPanel() {
		...
		mntmListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				listarClientes = new PainelListagemClientes();
				setContentPane(listarClientes);
				revalidate();			
...
//		getContentPane().add(desktopPane);
		...
		add(lblDesenvolvidoPorAdrian, BorderLayout.SOUTH);
